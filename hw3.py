...
class player_module:
    ...
    def decision(self,player_data, enemy_data):
        ...
        for data in enemy_data:
            ...
            #################################################
            # boss dy = -0.001
            if 6 not in enemyonscreen and (type in [0]) and dist < 0.212:
            ...
            if 6 in enemyonscreen and (type in [0]) and dist < 0.3 and y < 1.1:
                print("WARNING! You will be hit!")
                will_be_hit = True
                # colculate the collision point x-coor.
                m_data = dy/dx
